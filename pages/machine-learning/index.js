    ...
    return (
        <main>
            ...
            <SingleHero
                ...
                midTitle={"Machine Learning and Data Science"}
                description={"Make sense of huge data and gain more insights in your customer's interests "}
                img={`bg-[url("/img/dubnight.jpg")]`}
                location={"Visualization and Reports"}
                property={"Insights from Predictive Analysis"}
            />
